...
Projects can also declare an optional `gallery` — an array of `{ src, caption }` items rendered as a captioned vertical stack on the detail page.
...
- Heroes render at 16:9 with `object-cover`, so crop to a 16:9 framing before drop-in. Recommended size: **1600 × 900**, under 400 KB.
